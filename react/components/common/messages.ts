...
export const messages = defineMessages({
  ...
  warehousesSource: { id: 'admin/options.warehouses.source' },
  warehousesTarget: { id: 'admin/options.warehouses.target' },
  warehousesSourceError: { id: 'admin/options.warehouses.source.error' },
  sourceWarehouse: { id: 'admin/options.sourceWarehouse' },
